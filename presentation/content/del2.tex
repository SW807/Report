...
\begin{itemize}\item Afhænger af det data der skal undersøges.\end{itemize}
}

\onslide<2>{
\item \textit{Hvordan oplyser vi patienten, om de informationer der er i hæftet, på en mobil platform?}
\begin{itemize}\item Kort guide associeret med hvert spørgsmål.\end{itemize}
}
%VIS HJÆLPE-FUNKTION

\onslide<3>{
\item \textit{Hvordan præsenteres HAM-D på en mobil platform uden en interviewer?}
\begin{itemize}\item Interview udføres af chatbot, særlig trænet til denne type opgave.\end{itemize}
}
%DET KAN MAN IKKE :P
%FORDI SVARET SKAL FORTOLKES (AF FAGFOLK)
