...
Under mødet med Psykolog Janne Rasmussen\cite[Afsnit 1.3]{faelles} blev der nævnt en metode kaldet stemningsregistrering.
Dette afsnit vil kortfattet beskrive denne metode og dens effekt.

Stemningsregistrering\cite[Appendiks F]{faelles} hjælper patienten med at reflektere over sit stemningsleje.
...
De er baseret på \citet[Appendiks F]{faelles}.
...
Vægten skal registreres mindst én gang om måneden.
Kvinder angiver her de dage de har menstruation.
Andre notater kan være ting som jobskifte, dødsfald, forelskelse, konflikter og lignende.

\subsection{Information før brug}
Patienten skal oplyses om hvordan han selv finder frem til sit stemningsleje.
Lige nu sker det ved at patienten får udleveret et hæfte som kan ses i \citet[Appendiks F]{faelles}).
