\subsection{Stemningsregistrering}\label{sindstilstand::stemningsregistrering}
...
Stemningsregistrering\cite[Appendiks F, Stemningsregistrering]{faelles} hjælper patienten med at reflektere over deres sindstilstand.
Det gør at patienten er mere klar over hvordan vedkommende har det.
Som hjælper under behandlingen, da det er lettere for behandleren at se hvordan patienten har det vha. stemningsregistreringen og patienten selv har en bedre forståelse for det.
Stemningsregistrering fungerer ved at patienten krydser af på et skema hver dag.
...
Det eneste krav er at patienten kender vedkommendes symptomer.
...
\begin{itemize}
	...
	\item \textbf{Svær mani}(rød), ekstatisk, meget grinende eller er vredladen og ofte udskældende, verbale eller fysiske kampe med andre, tror på vedkommende har særlige evner, læse tanker, hører stemmer, konstant bevægelse, sover meget lidt eller ikke, mister kontrollen.
...
\paragraph{Angst}
Angst angives på en skala fra nul til og med 3.
\begin{itemize}
