...
Stemningsregistrering \stefan{ref til Måling af sindstilstand} bruger en skala fra ``svær depression'' til ``svær mani'' til at holde øje med hvor patientens stemningsleje.
...
\paragraph{Skala}
I metoden PANAS \stefan{ref til Måling af sindstilstand}spilles patienten et spørgsmål om i hvor høj grad han har følt en bestemt følelse i en vis tidsperiode.
