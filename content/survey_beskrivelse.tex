...
Stemningsregistrering, \cref{sindstilstand::stemningsregistrering}, bruger en skala fra ``svær depression'' til ``svær mani'' til at holde øje med hvor patientens stemningsleje.
...
\paragraph{Tekst}
For at give mulighed for at patienten kan skrive dagbog \stefan{ref til Måling af sindstilstand} skal der bruges en spørgsmålstype der kan vise en kort tekst som besvares med en tekst fra et tekstfelt.
...
\paragraph{Skala}
I metoden PANAS \stefan{ref til Måling af sindstilstand}stilles patienten et spørgsmål om i hvor høj grad han har følt en bestemt følelse i en vis tidsperiode.
